                        ...
                        const char  *encoding_name)
{
	...
	printf(" HPDF_BasicEncoder_New encoding name = %s \n",encoding_name);
                            ...
                            const HPDF_UNICODE  *map)
{
	...
	printf((" HPDF_BasicEncoder_CopyMap\n"));
                                ...
                                const HPDF_UNICODE  *map)
{
	...
	printf((" HPDF_BasicEncoder_OverrideMap\n"));
    ...
    for (i = 0; i <= HPDF_BASIC_ENCODER_LAST_CHAR -
        ...
        if (*map != *dst) {
		    printf(" i = %d  map = %d dst = %d \n" ,i, *map, *dst );
			//printf("difference %d and %d \n", *map, *dst );
            *dst = *map;
            *flgs = 1;
        }
        map++;
...
HPDF_UnicodeToGryphName  (HPDF_UNICODE  unicode)
{
	...
	printf((" HPDF_UnicodeToGryphName\n"));
